...
export const TP_TIMES = Object.freeze([
    1, 13, 25, 37, 49, 61,
...
export const TP_DATASET = Object.freeze(TP_TIMES.reduce((res, cur) => {
    res[cur] = STATIC_URL +`simul-result/lake/TP/TP_${prefixInteger(cur, 3)}.bin`;
    return res;
}, {}))
export const TP_META = deepFreeze({
    extent: {
        type: 'extent',
...
export const TP_COLOR_STOPS = Object.freeze([
