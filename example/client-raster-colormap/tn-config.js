...
export const TN_TIMES = Object.freeze([
    1, 13, 25, 37, 49, 61,
...
export const TN_DATASET = Object.freeze(TN_TIMES.reduce((res, cur) => {
    res[cur] = STATIC_URL +`simul-result/lake/TN/TN_${prefixInteger(cur, 3)}.bin`;
    return res;
}, {}))
export const TN_META = deepFreeze({
    extent: {
        type: 'extent',
...
export const TN_COLOR_STOPS = Object.freeze([
